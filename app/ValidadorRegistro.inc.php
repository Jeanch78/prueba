...
class ValidadorRegistro{
    ...
    private function validar_nombre($conexion,$nombre){
        ...
        if(strlen($nombre)<6){
            return "el nombre debe contener más 6 caracteres";
        }
        if(strlen($nombre)>24){
            return "el nombre no puede ocupar más de 24 caracteres";
        }
        if(RepositorioUsuario::nombre_existe($conexion,$nombre)){
            return"este nombre de usuario esta en uso. por favor prueve con otro";
    ...
    private function validar_email($conexion,$email){
        ...
        if(RepositorioUsuario::email_existe($conexion,$email)){
            return"este email ya esta en uso. por favor, prueve con otro email o <a href='#'>intente recuperar su contraseña";
        }
        return "";
    }
    ...
    public function obtener_error_clave2(){
        return $this->error_clave; //error_clave2; <->
    }
    //mostrar errores en un recuadro en la pagina de registro
